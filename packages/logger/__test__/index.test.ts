...
describe('logger 包测试', async () => {
  ...
  it('needTrace 测试', () => {
    ...
    const idx = globalIdx;
    logger.info('info 输出');
    expect(logBeforeInfo[idx]).toMatchInlineSnapshot(`"{"kind":"info","messages":["info输出"],"logConf":{"kind":"info","tagColor":"#000","tagBg":"#d9d9d9","contentColor":"#000","contentBg":"#fff","borderColor":"#d9d9d9"}}"`);
    expect(outputMessage[idx].includes('TRACE')).toBe(true);
  });
  ...
  it('中断输出测试', () => {
    ...
    const idx = globalIdx;
    logger.info('中断输出测试');
    expect(logBeforeInfo[idx]).toMatchInlineSnapshot(`undefined`);
    expect(outputMessage[idx]).toMatchInlineSnapshot(`undefined`);
  });
  ...
  it('重写输出样式测试, 保证顺序一致', () => {
    ...
    const idx = globalIdx;
    logger.info('info 输出');
    expect(logBeforeInfo[idx]).toMatchInlineSnapshot(`"{"kind":"info","messages":["info输出"],"logConf":{"kind":"info","tagColor":"#fff","tagBg":"#eb2f96","contentColor":"#000","contentBg":"#fff","borderColor":"#eb2f96","inherit":"debug"}}"`);
    expect(outputMessage[idx]).toMatchInlineSnapshot(`"["%cINFO%c\\n%cinfo输出","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;color:#fff;background:#eb2f96;border-radius:0.4rem0.4rem00;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;"]"`);
    const idx2 = globalIdx;
    logger.test('test 输出');
    expect(logBeforeInfo[idx2]).toMatchInlineSnapshot(`"{"kind":"test","messages":["test输出"],"logConf":{"kind":"test","inherit":"debug","tagColor":"#fff","tagBg":"#eb2f96","contentColor":"#000","contentBg":"#fff","borderColor":"#eb2f96"}}"`);
    expect(outputMessage[idx2]).toMatchInlineSnapshot(`"["%cTEST%c\\n%ctest输出","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;color:#fff;background:#eb2f96;border-radius:0.4rem0.4rem00;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;"]"`);
    const idx3 = globalIdx;
    logger.customStyle('自定义', '输出样式');
    expect(logBeforeInfo[idx3]).toMatchInlineSnapshot(`"{"kind":"customStyle","messages":["自定义","输出样式"],"logConf":{"kind":"customStyle","inherit":"info","tagColor":"#000","tagBg":"#d9d9d9","contentColor":"#000","contentBg":"#fff","borderColor":"#d9d9d9"}}"`);
    expect(outputMessage[idx3]).toMatchInlineSnapshot(`"["%cCUSTOMSTYLE%c\\n%c自定义输出样式","{\\"kind\\":\\"customStyle\\",\\"inherit\\":\\"info\\",\\"tagColor\\":\\"#000\\",\\"tagBg\\":\\"#d9d9d9\\",\\"contentColor\\":\\"#000\\",\\"contentBg\\":\\"#fff\\",\\"borderColor\\":\\"#d9d9d9\\"}","line-height:1.5;","contentstyle"]"`);
    // 调整 logConfig 顺序
    ...
    expect(logBeforeInfo[idx4]).toMatchInlineSnapshot(`"{"kind":"info","messages":["info输出"],"logConf":{"kind":"info","tagColor":"#fff","tagBg":"#eb2f96","contentColor":"#000","contentBg":"#fff","borderColor":"#eb2f96","inherit":"debug"}}"`);
    expect(outputMessage[idx4]).toMatchInlineSnapshot(`"["%cINFO%c\\n%cinfo输出","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;color:#fff;background:#eb2f96;border-radius:0.4rem0.4rem00;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;"]"`);
    const idx5 = globalIdx;
    logger2.test('test 输出');
    expect(logBeforeInfo[idx5]).toMatchInlineSnapshot(`"{"kind":"test","messages":["test输出"],"logConf":{"kind":"test","inherit":"debug","tagColor":"#fff","tagBg":"#eb2f96","contentColor":"#000","contentBg":"#fff","borderColor":"#eb2f96"}}"`);
    expect(outputMessage[idx5]).toMatchInlineSnapshot(`"["%cTEST%c\\n%ctest输出","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;color:#fff;background:#eb2f96;border-radius:0.4rem0.4rem00;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;"]"`);
  });
  ...
  it('多类型数据输出测试', () => {
    ...
    expect(logBeforeInfo[idx]).toMatchInlineSnapshot(`"{"kind":"info","messages":["字符串",{"array":[123],"number":123,"map":{},"set":{}},null,[1,2,3,{"a":1,"b":2}]],"logConf":{"kind":"info","tagColor":"#fff","tagBg":"#eb2f96","contentColor":"#000","contentBg":"#fff","borderColor":"#eb2f96","inherit":"debug"}}"`);
    expect(outputMessage[idx]).toMatchInlineSnapshot(`"["%cINFO%c\\n%c字符串{%c\\n%carray:[%c\\n%c123,%c\\n%c],%c\\n%cnumber:123,%c\\n%cmap:Map(3)[%c\\n%c{{name:\\"objectKey\\",}=>[]},%c\\n%c{123=>\\"\\"},%c\\n%c{Symbol(key)=>{}},%c\\n%c],%c\\n%cset:Set(5){%c\\n%c1,%c\\n%c\\"2\\",%c\\n%cSymbol(3),%c\\n%c[],%c\\n%c{},%c\\n%c},%c\\n%c}Symbol(symbol)[%c\\n%c1,%c\\n%c2,%c\\n%c3,%c\\n%c{%c\\n%ca:1,%c\\n%cb:2,%c\\n%c},%c\\n%c]","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;color:#fff;background:#eb2f96;border-radius:0.4rem0.4rem00;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-radius:00.4rem00;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-radius:0;","line-height:1.5;","line-height:1.5;padding:0.1rem0.4rem;border:0.1remsolid#eb2f96;margin-top:-0.12rem;color:#000;background:#fff;border-radius:00.4rem0.4rem;border-top:none;border-top-right-radius:0;"]"`);
  });

  // expect(logBeforeInfo).tMatchInlineSnapshot();
  // expect(outputMessage).tMatchInlineSnapshot();
});
